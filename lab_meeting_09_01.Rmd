...
Deactivation experiments have been recently used to causally identify the effects of Facebook on users' behavior and attitudes .red[(Asimovic et al 2021 and Alcott et al 2020)]. Deactivating WhatsApp users is **theoretically and empirically hard**.
...
- `r icons::fontawesome("question")` .red[Issue Polarization] `r icons::fontawesome("question")`
